    ...
    <!-- END Stylesheets -->
        ...
        echo "
                                ...
                                <div class=\"form-group col-xl-4\">
                                    ...
                                    <select class=\"js-select2 form-control\" id=\"example-select2\" name=\"room\" style=\"width: 100%;\" data-placeholder=\"Choose one..\">
...
<script>jQuery(function(){One.helpers(['flatpickr', 'datepicker', 'colorpicker', 'maxlength', 'select2', 'masked-inputs', 'rangeslider']);});</script>
   ...
   {% endblock %}
", "booking/index.twig", "D:\\OpenServer\\domains\\office-booking.my\\resources\\views\\booking\\index.twig");
    }
}
